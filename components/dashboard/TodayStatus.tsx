...
function createCountdownNotice(
  ...
  return {
    ...
    type:
      "countdown",
    title:
      "Nedräkning avslutas idag",
    description:
      `🎉 ${countdown.title} är idag!`,
  };
}
