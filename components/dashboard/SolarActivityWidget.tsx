          ...
          <div className="grid gap-4 lg:grid-cols-[230px_1fr]">
            ...
            <div className="grid gap-3 sm:grid-cols-2">
              <SpaceStat
                ...
                description="Aktuell geomagnetisk aktivitet, skala 0–9."
              />
              ...
              <SpaceStat
                ...
                label="Högsta senaste dygnet"
                value={String(
                  data.maxKp24h
                )}
                description="Högsta Kp-värdet i den aktuella NOAA-datan."
              />
              ...
              <SpaceStat
                ...
                description="Nästa tillgängliga prognostiserade Kp-värde."
              />
              ...
              <SpaceStat
                ...
                description="Högsta Kp i den aktuella prognosperioden."
              />
            </div>
          </div>
