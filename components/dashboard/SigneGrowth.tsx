    ...
    <div className="grid gap-5">
            ...
            {latestMeasurement ? (
                  ...
                  <div className="rounded-2xl border border-violet-300/15 bg-violet-400/[0.06] p-4">
                    ...
                    {averageWeightChangePerDay !== null && (
                      <p className="mt-2 text-sm text-slate-400">
                        ...
                        {averageWeightChangePerDay.toFixed(1)} g/dag
              ...
              <div className="rounded-2xl border border-dashed border-white/15 bg-white/[0.03] p-7 text-center">
                ...
                <p className="mt-1 text-sm text-slate-400">
                  Lägg till Signes första vikt och längd nedan.
                </p>
              </div>
            )}
      ...
      {section === "weight" && !isLoading && measurements.length > 0 && (
          <Card
            ...
            icon={<Scale size={28} />}
            storageKey="signe-growth-weight-chart"
          >
      ...
      {section === "height" && !isLoading && measurements.length > 0 && (
          <Card
            ...
            icon={<Ruler size={28} />}
            storageKey="signe-growth-height-chart"
          >
            <div className="h-72 w-full">
              <ResponsiveContainer width="100%" height="100%">
                <LineChart
